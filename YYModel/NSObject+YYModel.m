                        ...
                        if (valueArr) {
                            ...
                            for (id one in valueArr) {
                                if ([one isKindOfClass:meta->_genericCls]) {
                                    ...
                                    if (newOne && [newOne yy_modelSetWithDictionary:one]) [objectArr addObject:newOne];
                                }
                            }
                        ...
                        if (meta->_genericCls) {
                            ...
                            [((NSDictionary *)value) enumerateKeysAndObjectsUsingBlock:^(NSString *oneKey, id oneValue, BOOL *stop) {
                                if ([oneValue isKindOfClass:[NSDictionary class]]) {
                                    ...
                                    NSObject *newOne = [cls new];
                                    if (newOne && [newOne yy_modelSetWithDictionary:(id)oneValue]) dic[oneKey] = newOne;
                                }
                            }];
                    ...
                    if (meta->_genericCls) {
                        ...
                        for (id one in valueSet) {
                            if ([one isKindOfClass:meta->_genericCls]) {
                                ...
                                NSObject *newOne = [cls new];
                                if (newOne && [newOne yy_modelSetWithDictionary:one]) [set addObject:newOne];
                            }
                        }
